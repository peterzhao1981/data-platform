...
import static com.mode.googleanalytics.GoogleAnalyticsParameter.*;
...
public class GoogleAnalyticsRequest<T> {
	...
	public T applicationIdentifier(String value) {
		setString(APPLICATION_IDENTIFIER, value);
		return (T) this;
	}
	public String applicationIdentifier() {
		return getString(APPLICATION_IDENTIFIER);
	}
	...
	public T geoId(String value) {
		setString(GoogleAnalyticsParameter.GEO_ID, value);
		return (T) this;
	}
	public String geoId() {
		return getString(GoogleAnalyticsParameter.GEO_ID);
	}
