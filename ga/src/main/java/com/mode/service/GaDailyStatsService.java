 ...
 */
@Service
public class GaDailyStatsService {
...
//                gaDailyStats.setUserAgent(gaDailyStatsExist.getUserAgent());
//
//                gaDailyStats.setGeoId(gaDailyStatsExist.getGeoId());
            }
            ...
            if (StringUtils.isEmpty(gaDailyStats.getUserAgent()) || StringUtils.isEmpty(gaDailyStats.getGeoId()))   {
                ...
                dailyStatsDao.updateUserAgentAndGeoId(gaDailyStats.getIp(), userAgent, geoId);
                gaDailyProcessDao.updateUserAgentAndGeoId(gaDailyStats.getIp(), userAgent, geoId);
            }
